...
GO
INSERT [dbo].[HoSoBenhAn] ([IDHoSo], [HoVaTenBN], [DCHI], [NSINH], [PHONE], [NgayLapHoSo], [NgayHetHanHoSo]) VALUES 
(N'HS1', N'Trần Văn An ', N'Quận 6', CAST(N'2004-02-28T00:00:00.000' AS DateTime), N'0981783235', CAST(N'2024-09-15T00:00:00.000' AS DateTime), CAST(N'2024-09-17T00:00:00.000' AS DateTime)),
(N'HS2', N'Nguyễn Viết Cường', N'Quận 3', CAST(N'2000-11-22T00:00:00.000' AS DateTime), N'0985823677', CAST(N'2024-09-20T00:00:00.000' AS DateTime), CAST(N'2024-09-23T00:00:00.000' AS DateTime)),
(N'HS3', N'Hoàng Mạnh Đức', N'Quận 4', CAST(N'2001-05-06T00:00:00.000' AS DateTime), N'0984365478', CAST(N'2024-09-22T00:00:00.000' AS DateTime), CAST(N'2024-09-26T00:00:00.000' AS DateTime)),
(N'HS4', N'Trương Quang Lâm', N'Quận Phú Nhuận', CAST(N'2003-12-01T00:00:00.000' AS DateTime), N'0987615788', CAST(N'2024-09-27T00:00:00.000' AS DateTime), CAST(N'2024-09-27T00:00:00.000' AS DateTime)),
(N'HS5', N'Nguyễn Thị Xuân', N'Quận Tân Bình', CAST(N'2004-03-04T00:00:00.000' AS DateTime), N'0983608965', CAST(N'2024-09-27T00:00:00.000' AS DateTime), CAST(N'2024-09-30T00:00:00.000' AS DateTime))
GO
INSERT [dbo].[PhieuDangKyKhamBenh] ([IDDK], [IDHoSo]) VALUES 
(N'PDK1', N'HS1 '),
(N'PDK2', N'HS2'),
(N'PDK3', N'HS3'),
(N'PDK4', N'HS4'),
